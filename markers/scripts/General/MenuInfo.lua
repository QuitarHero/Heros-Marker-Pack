...
--Marker Pack Links
HMP_MainMenu:Add("Latest Marker Release (v2.7.9)", function (Copy) User.SetClipboard("https://github.com/QuitarHero/Heros-Marker-Pack/releases/latest", "Marker Pack Release Log copied to clipboard.") end, false, false, "Copies the latest marker pack\nrelease log to your clipboard.")
