...
--Marker Pack Links
HMP_MainMenu:Add("Latest Marker Release (v2.7.1)", function (Copy) User.SetClipboard("https://github.com/QuitarHero/Heros-Marker-Pack/releases/latest", "Marker Pack Release Log copied to clipboard.") end, false, false, "Copies the latest marker pack\nrelease log to your clipboard.")
...
--Pack Script Toggle
HMP_MainMenu:Add("Pack Script Toggle", TogglePackScriptToggle, true, GetBool("PackScriptToggle"), "If enabled, allows pack scripts to run.\nIf disabled, prevents pack scripts from running.\nRequires a Blish HUD restart or 'Reload Markers' to take effect.")