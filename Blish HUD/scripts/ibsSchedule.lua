...
local function tick_ibsStrikeSch(gameTime)
  --Time Variables
  local remain = HMP.publicFunctions.getUtcTime(6, 0)
...
Debug:Print("HMP: IBS Strike Schedule Script Loaded.")